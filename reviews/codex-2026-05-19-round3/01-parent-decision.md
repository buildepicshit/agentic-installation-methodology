...
exec
/home/linuxbrew/.linuxbrew/bin/bash -c "find specs -path '*reviews*' -type f | sort | sed -n '1,200p'" in /var/home/hasnobeef/buildepicshit/bes-fleet-policy
 succeeded in 0ms:
exec
/home/linuxbrew/.linuxbrew/bin/bash -c 'git show --stat --oneline --decorate --no-renames 2496545 && git show --name-only --format=fuller 2496545 -- specs/2026-05-18-agentic-installation-methodology/SPEC.md' in /var/home/hasnobeef/buildepicshit/bes-fleet-policy
 succeeded in 0ms:
2496545 (HEAD -> main, origin/main, origin/HEAD) spec(amend r2): parent Decision §4/§6/§7/§9/§11/§12 Round-2 carry-through fixes (codex Round-2 findings 1.2 PARTIAL, 1.4 PARTIAL, §7 stale, §11/§12 stale)
 .../SPEC.md                                        | 93 +++++++++++++++-------
 1 file changed, 64 insertions(+), 29 deletions(-)
commit 2496545b093f5530c10b5323a0f40ece048bcab3
Author:     HasNoBeef <alaindormehl@gmail.com>
AuthorDate: Tue May 19 16:04:52 2026 -0700
Commit:     HasNoBeef <alaindormehl@gmail.com>
CommitDate: Tue May 19 16:04:52 2026 -0700

    spec(amend r2): parent Decision §4/§6/§7/§9/§11/§12 Round-2 carry-through fixes (codex Round-2 findings 1.2 PARTIAL, 1.4 PARTIAL, §7 stale, §11/§12 stale)
    
    Round-2 codex re-review caught carry-through gaps the Round-1
    amendments introduced. This commit closes them.
    
    1.2 PARTIAL -> RESOLVED:
    - §4 Decision Criteria gains the "Executable conformance +
      signed-distribution surface" criterion (was missing post-§7.B).
    - §4 also captures the rename to "Failure-mode + open-question
      publication surface" so §4/§6 stay aligned.
    - §7 disambiguates "first-class" (structural status) from
      "signed-execution readiness" (release-time tooling). Manifest
      schema MUST include the signature field at v1.0; cryptographic
      signing of the v1.0 release MAY land unsigned with explicit
      signature.status: unsigned disclosure.
    
    1.4 PARTIAL -> RESOLVED:
    - §9 Forecloses rewritten to foreclose on longread-omission
      rather than the previous "shape-without-SPEC-bundle" umbrella.
      The previous umbrella missed the academic-primary + SPEC-bundle
      composite variant of 5.5; the longread-omission framing catches
      every rejected shape uniformly.
    
    §7 stale facet-catalog reference -> FIXED:
    - "additional sub-spec facets beyond the eight catalogued in §6
      above" replaced with explicit reference to §7's own facet list
      (the eight original + the two first-class structural facets
      from §7.B). §6 is the trade-off matrix, not a facet catalogue.
    
    §11 + §12 stale candidate counts -> FIXED:
    - §11 Check 1: "Candidates 5.1-5.4" -> "5.1-5.6".
    - §12 AC-2: "this SPEC compares 4" -> "compares 6".
    - §12 AC-3: "6 × 4 cells filled" -> "7 criteria × 6 candidates =
      42 cells filled".
    
    Lint clean post-edit (64 citation hits, 0 errors, 0 warnings).

specs/2026-05-18-agentic-installation-methodology/SPEC.md

codex
The Round-3 commit message explicitly claims fixes for all four Round-2 follow-ups. I don’t see review files under `specs/` yet, so I’m locating the referenced Round-2 artifact and then I’ll verify the exact current lines in the SPEC.
exec
/home/linuxbrew/.linuxbrew/bin/bash -c 'git diff 2496545''^ 2496545 -- specs/2026-05-18-agentic-installation-methodology/SPEC.md' in /var/home/hasnobeef/buildepicshit/bes-fleet-policy
exec
/home/linuxbrew/.linuxbrew/bin/bash -c 'rg -n "''^#|''^##|Decision Criteria|first-class|unsigned|Forecloses|academic|eight|catalogued|Candidates 5'"\\.1|5\\.1-5\\.4|5\\.1-5\\.6|6 × 4|6x4|42 cells|compares 4|compares 6|signature|signed|sub-spec|composite|umbrella|Failure-mode|Executable conformance\" specs/2026-05-18-agentic-installation-methodology/SPEC.md" in /var/home/hasnobeef/buildepicshit/bes-fleet-policy
 succeeded in 0ms:
...
@@ -303,17 +304,26 @@ front-door manifest plus per-facet sub-specs (architecture,
...
@@ -368,10 +378,17 @@ agents while keeping Phase 3-6 (composition + validation) on
...
exec
/home/linuxbrew/.linuxbrew/bin/bash -c "find .. -path '*agentic-installation-methodology*round2*' -type f -maxdepth 6 | sort" in /var/home/hasnobeef/buildepicshit/bes-fleet-policy
 succeeded in 0ms:
...
exec
/home/linuxbrew/.linuxbrew/bin/bash -c "nl -ba specs/2026-05-18-agentic-installation-methodology/SPEC.md | sed -n '120,295p'" in /var/home/hasnobeef/buildepicshit/bes-fleet-policy
 succeeded in 0ms:
...
exec
/home/linuxbrew/.linuxbrew/bin/bash -c "sed -n '1,260p' ../agentic-installation-methodology/reviews/codex-2026-05-19-round2/01-parent-decision.md" in /var/home/hasnobeef/buildepicshit/bes-fleet-policy
 succeeded in 0ms:
Reading additional input from stdin...
OpenAI Codex v0.129.0 (research preview)
--------
...
exec
/home/linuxbrew/.linuxbrew/bin/bash -c "nl -ba specs/2026-05-18-agentic-installation-methodology/SPEC.md | sed -n '292,485p'" in /var/home/hasnobeef/buildepicshit/bes-fleet-policy
 succeeded in 0ms:
   292	## 7. Decision Statement
   293	
   294	The studio SHALL adopt Candidate 5.1 (Hybrid — longread +
...
exec
/home/linuxbrew/.linuxbrew/bin/bash -c "nl -ba specs/2026-05-18-agentic-installation-methodology/SPEC.md | sed -n '486,620p'" in /var/home/hasnobeef/buildepicshit/bes-fleet-policy
 succeeded in 0ms:
...
exec
/home/linuxbrew/.linuxbrew/bin/bash -c "rg -n \"5\\.1-5\\.4|Candidates 5\\.1|compares 4|6 × 4|6x4|six by four|eight catalogued in §6|catalogued in §6|shape-without-SPEC-bundle|first-class at v1\\.0|unsigned at the v1\\.0|MAY land unsigned|signed-execution|academic-channel-primary|academic-primary|composite|longread omission|criteria × candidates|7 criteria|42 cells\" specs/2026-05-18-agentic-installation-methodology/SPEC.md ../agentic-installation-methodology/reviews/codex-2026-05-19-round2/01-parent-decision.md" in /var/home/hasnobeef/buildepicshit/bes-fleet-policy
 succeeded in 0ms:
specs/2026-05-18-agentic-installation-methodology/SPEC.md:313:"first-class" structural status from signed-execution
specs/2026-05-18-agentic-installation-methodology/SPEC.md:318:suite's signed-execution capability — IS first-class at
specs/2026-05-18-agentic-installation-methodology/SPEC.md:323:specific release MAY land unsigned at the v1.0 release
specs/2026-05-18-agentic-installation-methodology/SPEC.md:449:    compose with a SPEC bundle (academic-channel-primary +
specs/2026-05-18-agentic-installation-methodology/SPEC.md:450:    bundle-attached), the longread omission means this
specs/2026-05-18-agentic-installation-methodology/SPEC.md:451:    composite shape is also foreclosed.
specs/2026-05-18-agentic-installation-methodology/SPEC.md:455:  previous "shape-without-SPEC-bundle" umbrella was
specs/2026-05-18-agentic-installation-methodology/SPEC.md:457:  not foreclose the academic-primary + SPEC-bundle composite
specs/2026-05-18-agentic-installation-methodology/SPEC.md:460:  the composite.)
specs/2026-05-18-agentic-installation-methodology/SPEC.md:505:- Check 1: Candidates 5.1-5.6 are real and distinct shapes;
specs/2026-05-18-agentic-installation-methodology/SPEC.md:507:  5.1-5.4 per codex remediation §7.A which added §5.5
specs/2026-05-18-agentic-installation-methodology/SPEC.md:533:      candidates and criteria (7 criteria × 6 candidates =
specs/2026-05-18-agentic-installation-methodology/SPEC.md:534:      42 cells filled post codex remediation §7.B which
../agentic-installation-methodology/reviews/codex-2026-05-19-round2/01-parent-decision.md:1365:unsigned at the v1.0 release with the signature block
../agentic-installation-methodology/reviews/codex-2026-05-19-round2/01-parent-decision.md:1423:the eight catalogued in §6 above when the case-study work
../agentic-installation-methodology/reviews/codex-2026-05-19-round2/01-parent-decision.md:1477:- Shipping Product B as any shape-without-SPEC-bundle —
../agentic-installation-methodology/reviews/codex-2026-05-19-round2/01-parent-decision.md:1530:- Check 1: Candidates 5.1-5.4 are real and distinct shapes;
../agentic-installation-methodology/reviews/codex-2026-05-19-round2/01-parent-decision.md:1552:      needed fields populated (this SPEC compares 4).
../agentic-installation-methodology/reviews/codex-2026-05-19-round2/01-parent-decision.md:1554:      candidates and criteria (6 × 4 cells filled).
../agentic-installation-methodology/reviews/codex-2026-05-19-round2/01-parent-decision.md:2492:   313	unsigned at the v1.0 release with the signature block
../agentic-installation-methodology/reviews/codex-2026-05-19-round2/01-parent-decision.md:2553:   371	the eight catalogued in §6 above when the case-study work
../agentic-installation-methodology/reviews/codex-2026-05-19-round2/01-parent-decision.md:2607:   425	- Shipping Product B as any shape-without-SPEC-bundle —
../agentic-installation-methodology/reviews/codex-2026-05-19-round2/01-parent-decision.md:2660:   478	- Check 1: Candidates 5.1-5.4 are real and distinct shapes;
../agentic-installation-methodology/reviews/codex-2026-05-19-round2/01-parent-decision.md:2682:   500	      needed fields populated (this SPEC compares 4).
../agentic-installation-methodology/reviews/codex-2026-05-19-round2/01-parent-decision.md:2684:   502	      candidates and criteria (6 × 4 cells filled).
../agentic-installation-methodology/reviews/codex-2026-05-19-round2/01-parent-decision.md:3162:   192	shape-without-SPEC-bundle" entry consolidating both
../agentic-installation-methodology/reviews/codex-2026-05-19-round2/01-parent-decision.md:3459:   313	   289	the eight catalogued in §6 above when the case-study work
../agentic-installation-methodology/reviews/codex-2026-05-19-round2/01-parent-decision.md:3539:   192	shape-without-SPEC-bundle" entry consolidating both
...
../agentic-installation-methodology/reviews/codex-2026-05-19-round2/01-parent-decision.md:3908:specs/2026-05-18-agentic-installation-methodology/SPEC.md:313:unsigned at the v1.0 release with the signature block
../agentic-installation-methodology/reviews/codex-2026-05-19-round2/01-parent-decision.md:3910:specs/2026-05-18-agentic-installation-methodology/SPEC.md:371:the eight catalogued in §6 above when the case-study work
../agentic-installation-methodology/reviews/codex-2026-05-19-round2/01-parent-decision.md:3916:specs/2026-05-18-agentic-installation-methodology/SPEC.md:478:- Check 1: Candidates 5.1-5.4 are real and distinct shapes;
../agentic-installation-methodology/reviews/codex-2026-05-19-round2/01-parent-decision.md:3917:specs/2026-05-18-agentic-installation-methodology/SPEC.md:500:      needed fields populated (this SPEC compares 4).
../agentic-installation-methodology/reviews/codex-2026-05-19-round2/01-parent-decision.md:3918:specs/2026-05-18-agentic-installation-methodology/SPEC.md:502:      candidates and criteria (6 × 4 cells filled).
../agentic-installation-methodology/reviews/codex-2026-05-19-round2/01-parent-decision.md:4002:   483	  list to consolidate shape-without-SPEC-bundle entries.
...
codex
The current SPEC has the four amended areas in place. I’m checking for collateral drift now: stale references in completion/reporting, matrix/candidate counts, and whether the new wording creates a new normative mismatch.
exec
/home/linuxbrew/.linuxbrew/bin/bash -c "nl -ba ../agentic-installation-methodology/reviews/codex-2026-05-19-round2/01-parent-decision.md | sed -n '4020,4080p'" in /var/home/hasnobeef/buildepicshit/bes-fleet-policy
 succeeded in 0ms:
  4020	
  4021	**Per-Finding Verdicts**
  4022	
  4023	1.1: RESOLVED.  
  4024	§5.5 now includes paper-style as a rejected candidate with rationale around academic channel fit, latency, format constraints, and audience mismatch. See [SPEC.md](/var/home/hasnobeef/buildepicshit/bes-fleet-policy/specs/2026-05-18-agentic-installation-methodology/SPEC.md:210).
  4025	
  4026	1.2: PARTIALLY RESOLVED.  
  4027	§7 and §9 now name conformance + signed-distribution as first-class, but the carry-through is inconsistent: §4 Decision Criteria still does not list/source/weight the new criterion, while §6/§8 rely on it. Also, §7 allows the signed-distribution surface to ship unsigned at v1.0, which conflicts with the remediation wording that binds “conformance + signing as first-class facets at v1.0.” See [SPEC.md](/var/home/hasnobeef/buildepicshit/bes-fleet-policy/specs/2026-05-18-agentic-installation-methodology/SPEC.md:126), [SPEC.md](/var/home/hasnobeef/buildepicshit/bes-fleet-policy/specs/2026-05-18-agentic-installation-methodology/SPEC.md:306), and [remediation SPEC.md](/var/home/hasnobeef/buildepicshit/agentic-installation-methodology/specs/2026-05-19-codex-remediation-amendments/SPEC.md:484).
  4028	
  4029	1.3: RESOLVED.  
  4030	The row rename is substantive, not cosmetic. The matrix now measures publication surface specifically, and rescoring blog/series/bundle-only away from the old generic “honest disclosure” framing is coherent. See [SPEC.md](/var/home/hasnobeef/buildepicshit/bes-fleet-policy/specs/2026-05-18-agentic-installation-methodology/SPEC.md:275).
  4031	
  4032	1.4: PARTIALLY RESOLVED.  
  4033	SPEC-bundle-only is now named, but §9’s umbrella says “shape-without-SPEC-bundle” while including SPEC-bundle-only, and it forecloses “paper-style only” even though §5.5 says paper-style could carry the same SPEC bundle with academic channel as primary. That leaves an academic-primary + SPEC-bundle path ambiguously unclosed. See [SPEC.md](/var/home/hasnobeef/buildepicshit/bes-fleet-policy/specs/2026-05-18-agentic-installation-methodology/SPEC.md:425).
  4034	
  4035	**New Findings**
  4036	
  4037	MAJOR: §7 still says “additional sub-spec facets beyond the eight catalogued in §6 above,” but §6 is the trade-off matrix, not a facet catalog, and the amendment just promoted conformance/signing beyond the original eight. This creates stale authority inside the normative section. See [SPEC.md](/var/home/hasnobeef/buildepicshit/bes-fleet-policy/specs/2026-05-18-agentic-installation-methodology/SPEC.md:370).
  4038	
  4039	MAJOR: Validation and Acceptance Criteria still describe the pre-amendment candidate/matrix shape: “Candidates 5.1-5.4,” “this SPEC compares 4,” and “6 × 4 cells,” despite the amended §5/§6 now having six candidates and seven criteria. See [SPEC.md](/var/home/hasnobeef/buildepicshit/bes-fleet-policy/specs/2026-05-18-agentic-installation-methodology/SPEC.md:478).
  4040	
  4041	ADVISORY: The target Decision’s Reversal Plan is §10, not §16. The §16 reference appears in the remediation Contract authority trail, not the target, and should be corrected for audit hygiene. See [remediation SPEC.md](/var/home/hasnobeef/buildepicshit/agentic-installation-methodology/specs/2026-05-19-codex-remediation-amendments/SPEC.md:126).
  4042	
  4043	RFC 2119 scoping is clean: uppercase normative keywords remain confined to the boilerplate and §7, and lint reported 0 errors / 0 warnings for both target artefacts.
  4044	
  4045	
  4046	tokens used
  4047	133,276
  4048	**Quality Gate Result**
  4049	
  4050	FAIL: no mutations; lint passes for both `IDEA.md` and `SPEC.md`, but the amended Decision still has material carry-through issues.
  4051	
  4052	**Per-Finding Verdicts**
  4053	
  4054	1.1: RESOLVED.  
  4055	§5.5 now includes paper-style as a rejected candidate with rationale around academic channel fit, latency, format constraints, and audience mismatch. See [SPEC.md](/var/home/hasnobeef/buildepicshit/bes-fleet-policy/specs/2026-05-18-agentic-installation-methodology/SPEC.md:210).
  4056	
  4057	1.2: PARTIALLY RESOLVED.  
  4058	§7 and §9 now name conformance + signed-distribution as first-class, but the carry-through is inconsistent: §4 Decision Criteria still does not list/source/weight the new criterion, while §6/§8 rely on it. Also, §7 allows the signed-distribution surface to ship unsigned at v1.0, which conflicts with the remediation wording that binds “conformance + signing as first-class facets at v1.0.” See [SPEC.md](/var/home/hasnobeef/buildepicshit/bes-fleet-policy/specs/2026-05-18-agentic-installation-methodology/SPEC.md:126), [SPEC.md](/var/home/hasnobeef/buildepicshit/bes-fleet-policy/specs/2026-05-18-agentic-installation-methodology/SPEC.md:306), and [remediation SPEC.md](/var/home/hasnobeef/buildepicshit/agentic-installation-methodology/specs/2026-05-19-codex-remediation-amendments/SPEC.md:484).
  4059	
  4060	1.3: RESOLVED.  
  4061	The row rename is substantive, not cosmetic. The matrix now measures publication surface specifically, and rescoring blog/series/bundle-only away from the old generic “honest disclosure” framing is coherent. See [SPEC.md](/var/home/hasnobeef/buildepicshit/bes-fleet-policy/specs/2026-05-18-agentic-installation-methodology/SPEC.md:275).
  4062	
  4063	1.4: PARTIALLY RESOLVED.  
  4064	SPEC-bundle-only is now named, but §9’s umbrella says “shape-without-SPEC-bundle” while including SPEC-bundle-only, and it forecloses “paper-style only” even though §5.5 says paper-style could carry the same SPEC bundle with academic channel as primary. That leaves an academic-primary + SPEC-bundle path ambiguously unclosed. See [SPEC.md](/var/home/hasnobeef/buildepicshit/bes-fleet-policy/specs/2026-05-18-agentic-installation-methodology/SPEC.md:425).
  4065	
  4066	**New Findings**
  4067	
  ...
  4071	
  4072	ADVISORY: The target Decision’s Reversal Plan is §10, not §16. The §16 reference appears in the remediation Contract authority trail, not the target, and should be corrected for audit hygiene. See [remediation SPEC.md](/var/home/hasnobeef/buildepicshit/agentic-installation-methodology/specs/2026-05-19-codex-remediation-amendments/SPEC.md:126).
  4073	
  4074	RFC 2119 scoping is clean: uppercase normative keywords remain confined to the boilerplate and §7, and lint reported 0 errors / 0 warnings for both target artefacts.
  4075	
  4076	

exec
/home/linuxbrew/.linuxbrew/bin/bash -c "rg -n \"4 candidates|4 candidate|6×4|6 × 4|47 citation|64 citation|5 candidates|Candidates 5\\.1-5\\.4|compares 4|all six|six candidates|seven criteria|7 criteria|42 cells|15/15|4 × 5|4x5|review gate|same-family|lint\" specs/2026-05-18-agentic-installation-methodology/SPEC.md" in /var/home/hasnobeef/buildepicshit/bes-fleet-policy
 succeeded in 0ms:
...
exec
/home/linuxbrew/.linuxbrew/bin/bash -c 'rg -n "§16|§14|§11|§12|§6|§7|§9|§10|Reversal Plan|Validation Plan|Acceptance Criteria|Completion Report|Decision Rationale|Locks|Decision Statement" specs/2026-05-18-agentic-installation-methodology/SPEC.md' in /var/home/hasnobeef/buildepicshit/bes-fleet-policy
 succeeded in 0ms:
...
608:  amendment per §9 (the "Implementations may adopt additional
610:- **Cross-family validation engagement cost**: §7 makes
625:  instead, the Decision binds shape and the §7 enumeration
629:  "Skip when" — this Completion Report reinforces it from the
639:- **Decision Statement as slice enumerator.** §7 enumerates
642:  follow-on Task / Contract SPECs cite specific §7 clauses

exec
/home/linuxbrew/.linuxbrew/bin/bash -c "sed -n '1,120p' specs/2026-05-18-agentic-installation-methodology/SPEC.md" in /var/home/hasnobeef/buildepicshit/bes-fleet-policy
 succeeded in 0ms:
---
...
exec
/home/linuxbrew/.linuxbrew/bin/bash -c 'ls -la specs/2026-05-18-agentic-installation-methodology ../agentic-installation-methodology/specs/2026-05-19-codex-remediation-amendments ../agentic-installation-methodology/reviews/codex-2026-05-19-round2' in /var/home/hasnobeef/buildepicshit/bes-fleet-policy
 succeeded in 0ms:
../agentic-installation-methodology/reviews/codex-2026-05-19-round2:
total 864
drwxr-xr-x. 1 hasnobeef hasnobeef    126 May 19 14:49 .
drwxr-xr-x. 1 hasnobeef hasnobeef    124 May 19 16:16 ..
-rw-r--r--. 1 hasnobeef hasnobeef  11635 May 19 14:49 00-SYNTHESIS.md
-rw-r--r--. 1 hasnobeef hasnobeef 272702 May 19 14:28 01-parent-decision.md
-rw-r--r--. 1 hasnobeef hasnobeef 270574 May 19 14:34 02-corpus.md
-rw-r--r--. 1 hasnobeef hasnobeef 319657 May 19 14:47 03-v2-repack.md

../agentic-installation-methodology/specs/2026-05-19-codex-remediation-amendments:
total 28
drwxr-xr-x. 1 hasnobeef hasnobeef    14 May 19 15:18 .
drwxr-xr-x. 1 hasnobeef hasnobeef   264 May 18 21:17 ..
-rw-r--r--. 1 hasnobeef hasnobeef 27979 May 19 15:18 SPEC.md

specs/2026-05-18-agentic-installation-methodology:
total 48
drwxr-xr-x. 1 hasnobeef hasnobeef    28 May 19 15:10 .
drwxr-xr-x. 1 hasnobeef hasnobeef  2910 May 18 15:52 ..
-rw-r--r--. 1 hasnobeef hasnobeef 12652 May 18 12:11 IDEA.md
-rw-r--r--. 1 hasnobeef hasnobeef 30111 May 19 15:10 SPEC.md

codex
One collateral issue is emerging in §14: the current §11/§12 counts are fixed, but the Completion Report still records the old review summary with “4 candidates” and “6×4 trade-off matrix.” I’m running the declared lint gates now to separate structural lint status from review-quality status.
exec
/home/linuxbrew/.linuxbrew/bin/bash -c "nl -ba specs/2026-05-18-agentic-installation-methodology/SPEC.md | sed -n '553,646p'" in /var/home/hasnobeef/buildepicshit/bes-fleet-policy
 succeeded in 0ms:
   553	## 14. Completion Report
   554	
   555	### 14.1 Files changed
   ...
   619	
   620	- **Decision SPECs cascade by id-citation, not TASK.md
   621	  decomposition.** The `approved-spec-decomposition` skill
   622	  correctly refused to emit TASK.md slices against this
   623	  Decision SPEC. Capture as durable lesson: agents authoring
   624	  Decision SPECs should not expect downstream decomposition;
   625	  instead, the Decision binds shape and the §7 enumeration
   626	  becomes the slice list for follow-on Task / Contract SPECs
   627	  that cite the Decision by id. Already documented in
   628	  `file://.claude/skills/approved-spec-decomposition/SKILL.md`
   629	  "Skip when" — this Completion Report reinforces it from the
   630	  Decision-author perspective.
   631	- **Rolls-royce directive as one-shot disposition resolver.**
   632	  `owner://transcript-2026-05-18` ("Do what is the rolls
   633	  royce") resolved 7 owner-blocking questions in one
   634	  utterance. The pattern: when the agent has done the research
   635	  homework and the candidate space is well-articulated, an
   636	  owner directive can disposition multiple questions with a
   637	  single binding statement. Document as authoring pattern for
   638	  the spec-authoring skill's "Grill Before IDEA" section.
   639	- **Decision Statement as slice enumerator.** §7 enumerates
   640	  the slice list (standup, repack, longread, SPEC-bundle,
   641	  validation pass) inside the normative section, which lets
   642	  follow-on Task / Contract SPECs cite specific §7 clauses
   643	  as their parent authority. This is the cascade-by-id-
   644	  citation pattern in action; consider documenting in
   645	  `references/cascade-by-id-citation.md`.

exec
/home/linuxbrew/.linuxbrew/bin/bash -c 'rg -n "MUST|MUST NOT|REQUIRED|SHALL|SHALL NOT|SHOULD|SHOULD NOT|RECOMMENDED|MAY|OPTIONAL" specs/2026-05-18-agentic-installation-methodology/SPEC.md' in /var/home/hasnobeef/buildepicshit/bes-fleet-policy
 succeeded in 0ms:
...
exec
/home/linuxbrew/.linuxbrew/bin/bash -c "nl -ba ../agentic-installation-methodology/specs/2026-05-19-codex-remediation-amendments/SPEC.md | sed -n '450,505p'" in /var/home/hasnobeef/buildepicshit/bes-fleet-policy
 succeeded in 0ms:
   450	      reviewer for triangulation? `judgment://agent-
   451	      synthesis`: same Codex is sufficient since the
   452	      amendments derive from its findings; using a third
   453	      family (Gemini? local OSS) for verification of the
   454	      verification is rolls-royce-on-rolls-royce. Default:
   455	      same Codex; mark Gemini cross-check as opt-in.
   456	- [ ] Q3: Manifest schema v2.1 (§7.E + §7.F) requires
   457	      consumers to update their tooling. The transition
   458	      plan — symlink shim? grace period? — was flagged
   459	      in Slice 2's residual risk. Default: no shims;
   460	      v2.0.0 stays at v2.0.0; v2.1 is opt-in.
   461	
   462	None of Q1-Q3 is `owner-blocking`; all can be deferred.
   463	
   464	## 18. Migration / Coexistence
   465	
   466	The amendments don't break v2.0.0 of agentic-ops-framework. <!-- lint-ok: no-citation -->
   467	The manifest schema bump (v2.1.0) is opt-in; v2.0.0
   468	consumers continue to work against the v2.0.0 schema. The
   469	corpus source-list bump (v1.1) requires
   470	check-corpus-completeness.sh to recognise the new version
   471	— a one-line script edit.
   472	
   473	The parent Decision amendments are SPEC-text only; no <!-- lint-ok: no-citation -->
   474	artefact migration is needed.
   475	
   476	## 19. Completion Report
   477	
   478	### 19.1 Files changed
   479	
   480	Per-amendment changes (sub-amendment → files):
   481	
   482	- §7.A (parent Decision §5/§9 candidate-space +
   483	  Locks): `bes-fleet-policy/specs/2026-05-18-agentic-installation-methodology/SPEC.md`
   484	  — inserted §5.5 (paper-style REJECTED) + §5.6
   485	  (SPEC-bundle-only REJECTED); rewrote §9 Forecloses
   486	  list to consolidate shape-without-SPEC-bundle entries.
   487	- §7.B (parent Decision §6/§7 first-class
   488	  facets): same file — added trade-off matrix row
   489	  "Executable conformance + signed-distribution
   490	  surface"; added §7 Decision Statement clause binding
   491	  conformance + signing as first-class facets at v1.0.
   492	- §7.C (parent Decision §6 trade-off matrix +
   493	  §8 rationale): same file — renamed "Honest
   494	  disclosure" row to "Failure-mode + open-question
   495	  publication surface"; updated §8 rationale to cite
   496	  the renamed criterion.
   497	- §7.D (corpus §6.1 source-list expansion):
   498	  `agentic-installation-methodology/specs/2026-05-19-primary-source-research-corpus/SPEC.md`
   499	  — added `json-schema` + `cyclonedx-sbom` rows;
   500	  bumped `SOURCE_LIST_VERSION` to v1.1. Also:
   501	  - `agentic-installation-methodology/research/primary-sources/json-schema.md`
   502	    (new; fetch_outcome partial — index page only).
   503	  - `agentic-installation-methodology/research/primary-sources/cyclonedx-sbom.md`
   504	    (new; fetch_outcome primary-read-complete).
   505	  - `agentic-installation-methodology/research/primary-sources/INDEX.md`

exec
/home/linuxbrew/.linuxbrew/bin/bash -c "nl -ba ../agentic-installation-methodology/specs/2026-05-19-codex-remediation-amendments/SPEC.md | sed -n '400,450p'" in /var/home/hasnobeef/buildepicshit/bes-fleet-policy
 succeeded in 0ms:
   400	## 14. Implementation Checklist (Definition of Done)
   401	
   402	- [ ] DoD-1: §7.A applied + parent Decision lint clean.
   403	- [ ] DoD-2: §7.B applied + parent Decision lint clean.
   404	- [ ] DoD-3: §7.C applied + parent Decision lint clean.
   405	- [ ] DoD-4: §7.D applied + corpus SPEC lint clean +
   406	      check script updated for v1.1 SOURCE_LIST_VERSION.
   407	- [ ] DoD-5: §7.E + §7.F applied + repack SPEC lint clean
   408	      + validate-manifest.sh updated for v2.1 schema.
   409	- [ ] DoD-6: §7.G follow-on Task SPEC queued in
   410	      Completion Report.
   411	- [ ] DoD-7: This Contract's §19 Completion Report filled
   412	      with per-amendment commit SHAs.
   413	- [ ] DoD-8: Re-run codex cross-family review on the
   414	      amended state (post-remediation gate) BEFORE any
   415	      further forward motion (chapter authoring, v2.1
   416	      tag, Product B v1.0 release).
   417	
   418	## 15. Acceptance Criteria
   419	
   420	(See §13 for tests.)
   421	
   422	- [x] AC-1: SPEC lint clean
   423	- [x] AC-2: amended target SPECs lint clean
   424	- [x] AC-3: corpus check script clean post-§7.D
   425	- [x] AC-4: validate-manifest clean post-§7.E+§7.F
   426	- [x] AC-5: §7.G Task SPEC obligation queued in
   427	      Completion Report
   428	- [x] AC-6: all amendment commits cite Contract id +
   429	      codex finding id
   430	
   431	## 16. Rollback Plan
   432	
   433	Each sub-amendment is a separate commit; rollback is per-
   434	commit `git revert`. If a single sub-amendment is rolled
   435	back, the others stand. If the entire batch is rolled
   436	back (e.g. the post-remediation codex review surfaces a
   437	structural flaw in the amendment approach), all seven
   438	sub-amendment commits revert and this Contract supersedes
   439	to needs-revision.
   440	
   441	## 17. Open Questions
   442	
   443	- [ ] Q1: §7.G corpus-citation lint extension authoring
   444	      timeline — within this remediation cycle, or
   445	      deferred to a separate Product B v1.x cycle?
   446	      Default: defer to its own cycle; do not block this
   447	      Contract.
   448	- [ ] Q2: Re-running cross-family review after this batch
   449	      lands (DoD-8) — same Codex (gpt-5.5) or different
   450	      reviewer for triangulation? `judgment://agent-

exec
/home/linuxbrew/.linuxbrew/bin/bash -c "nl -ba ../agentic-installation-methodology/specs/2026-05-19-codex-remediation-amendments/SPEC.md | sed -n '505,545p'" in /var/home/hasnobeef/buildepicshit/bes-fleet-policy
 succeeded in 0ms:
   505	  - `agentic-installation-methodology/research/primary-sources/INDEX.md`
   506	    — version line bumped + two new rows.
   507	  - `agentic-installation-methodology/scripts/check-corpus-completeness.sh`
   508	    — `EXPECTED_VERSION` bumped to v1.1.
   509	- §7.E (v2.0 repack §6.1/§8 schema expansion):
   510	  `agentic-ops-framework/specs/2026-05-19-v2-manifest-catalog-repack/SPEC.md`
   511	  — §8.1 top-level keys expanded with schema_uri,
   512	  source_commit, source_tag, provenance; §8.6
   513	  provenance block added; §8.3 facet record gained
   514	  media_type/digest/size/status fields. Also:
   515	  - `agentic-ops-framework/spec-bundle/manifest.yaml`
   516	    — bumped spec_version to 2.1.0; populated new
   517	    fields (schema_uri, source_tag, per-facet
   518	    media_type + status, resources media_type +
   519	    conformance reserved-status, provenance block,
   520	    signature block).
   521	  - `agentic-ops-framework/scripts/validate-manifest.sh`
   522	    — `EXPECTED_SPEC_VERSION` bumped to 2.1.0.
   523	- §7.F (v2.0 repack §8.3 + validate-manifest behavior
   524	  fix): same target SPEC — §8.3 facet record now
   525	  explicitly supports directory primary with
   526	  primary_index field. Validator update lands as
   527	  follow-on Task SPEC (the current validator already
   528	  silently allowed directory primaries; the explicit
   529	  primary_index enforcement is a v2.1 validator
   530	  feature).
   531	- §7.G (corpus-citation lint extension obligation):
   532	  no inline files changed; recorded in §19.5 as
   533	  spec-evidence + queued for follow-on Task SPEC
   534	  authoring.
   535	
   536	### 19.2 Commands run
   537	
   538	- `cmd://bash agents/scripts/lint-spec.sh
   539	  specs/2026-05-18-agentic-installation-methodology/SPEC.md`
   540	  in bes-fleet-policy → exit 0 post-amendments
   541	  (62 citation hits, 0 errors, 0 warnings).
   542	- `cmd://bash scripts/lint-spec.sh
   543	  specs/2026-05-19-primary-source-research-corpus/SPEC.md`
   544	  in agentic-installation-methodology → exit 0
   545	  (55 citation hits, 0 errors, 0 warnings).

exec
/home/linuxbrew/.linuxbrew/bin/bash -c 'git status --short' in /var/home/hasnobeef/buildepicshit/bes-fleet-policy
 succeeded in 0ms:
exec
/home/linuxbrew/.linuxbrew/bin/bash -c "nl -ba ../agentic-installation-methodology/specs/2026-05-19-codex-remediation-amendments/SPEC.md | sed -n '160,260p'" in /var/home/hasnobeef/buildepicshit/bes-fleet-policy
exec
/home/linuxbrew/.linuxbrew/bin/bash -c 'rg -n "''^## 7|''^### 7'"\\.|conformance|signed|paper-style|SPEC-bundle-only|Honest disclosure|Failure-mode|shape-without|first-class\" ../agentic-installation-methodology/specs/2026-05-19-codex-remediation-amendments/SPEC.md" in /var/home/hasnobeef/buildepicshit/bes-fleet-policy
 succeeded in 0ms:
   160	   1.3.
   161	3. **Source-list expansion** (corpus §6.1): finding 2.3.
   162	4. **Schema expansion + drift fix** (v2.0 repack §6.1,
   163	   §8): findings 3.5, 3.6.
   164	5. **New tooling Task SPEC** (queued as follow-on, not
   165	   inline): finding 4.2.
   166	
   167	## 7. Pipeline Specification (the seven sub-amendments)
   168	
   169	### §7.A — Parent Decision §5: add paper-style + bundle-only candidates (finding 1.1, 1.4)
   170	
   171	Target:
   172	`file://../../../bes-fleet-policy/specs/2026-05-18-agentic-installation-methodology/SPEC.md`
   173	§5 Candidate Options.
   174	
   175	Patch: insert two new candidates §5.5 and §5.6 with the
   176	required fields (Description / Fit-with-substance /
   177	Fit-with-constraints / Cost / Risk), labelled REJECTED
   178	with rationale:
   179	
   180	- §5.5 Paper-style (arxiv / workshop) — rejected because
   181	  it doubles down on the spec-as-distribution claim by
   182	  publishing through an academic channel, but the
   183	  academic channel adds review latency + format
   184	  constraints that conflict with the methodology's
   185	  honest-experiential posture; the longread channel
   186	  delivers the same content with less ceremony.
   187	- §5.6 SPEC-bundle-only (no longread) — rejected because
   188	  it sacrifices the case-study density per parent §8
   189	  Posture; identical reasoning to candidate 5.2 but
   190	  named explicitly as a rejected shape.
   191	
   192	§9 Locks UPDATE: add SPEC-bundle-only and paper-style to
   193	the "Forecloses" list. Move the existing blog-only +
   194	series-only entries into a single "Forecloses
   195	shape-without-SPEC-bundle" entry consolidating both
   196	underspecified-publication-channel options.
   197	
   198	### §7.B — Parent Decision §6 + §7: conformance + signing as first-class facets (finding 1.2)
   199	
   200	Target: parent Decision SPEC §6 Trade-off Comparison + §7
   201	Decision Statement.
   202	
   203	Patch:
   204	
   205	- §6 trade-off criteria UPDATE: add a new criterion
   206	  "executable conformance + signed-distribution
   207	  surface" with high weight, sourced from research §5.1.
   208	- §7 Decision Statement INSERT: a clause stating
   209	  conformance suite + signed distribution are
   210	  **first-class** facets of the SPEC bundle, not
   211	  "additional facets requiring amendment". The §9 Locks
   212	  list moves these from "amend to add" status to
   213	  "REQUIRED at v1.0".
   214	
   215	### §7.C — Parent Decision §6 + §8: disambiguate honest-disclosure matrix row (finding 1.3)
   216	
   217	Target: parent Decision SPEC §6 trade-off matrix +
   218	§8 Decision Rationale row 3 reference.
   219	
   220	Patch:
   221	
   222	- §6 RENAME the "honest disclosure" criterion to
   223	  "failure-mode + open-question publication surface".
   224	  Re-score the candidates so this criterion measures only
   225	  the publication surface (whether the format LANDS
   226	  failure modes + open questions as first-class
   227	  content), not whether they're "disclosed" generically
   228	  (which the longread + SPEC bundle + blog + series all
   229	  technically can).
   230	- §8 UPDATE rationale citing this criterion's new
   231	  precise name.
   232	
   233	### §7.D — Corpus Contract §6.1: source-list expansion (finding 2.3)
   234	
   235	Target:
   236	`file://../2026-05-19-primary-source-research-corpus/SPEC.md`
   237	§6.1 In-scope sources (v1.0).
   238	
   239	Patch: add two REQUIRED v1.0 entries to the §6.1 table
   240	(and bump `SOURCE_LIST_VERSION` to v1.1; updates the
   241	check script's expectation):
   242	
   243	- `json-schema` — JSON Schema spec (Draft 2020-12);
   244	  primary URL `url://json-schema.org/specification.html`.
   245	  Methodology relevance: Helm values-schema + OpenAPI
   246	  3.1 both rely on JSON Schema; the methodology's
   247	  customization sub-spec validates against JSON Schema;
   248	  citing Helm + OpenAPI without citing the underlying
   249	  primitive is a transitive citation gap.
   250	- `cyclonedx-sbom` — CycloneDX SBOM specification;
   251	  primary URL `url://cyclonedx.org/specification/overview/`.
   252	  Methodology relevance: the methodology's audit /
   253	  provenance story (research §4.4 + LeadDev §3
   254	  regulated-environments framing) needs a primary SBOM
   255	  source.
   256	
   257	Two additional candidates flagged but NOT v1.0
   258	mandatory (deferred to v1.1 corpus expansion):
   259	`dev-container-spec`, `slsa-in-toto`. These remain in
   260	§17 Open Questions as v1.1 candidates.
...
494:  disclosure" row to "Failure-mode + open-question
519:    conformance reserved-status, provenance block,
552:  PASS — manifest schema 2.1.0, conformance core,

exec
/home/linuxbrew/.linuxbrew/bin/bash -c "nl -ba ../agentic-installation-methodology/specs/2026-05-19-codex-remediation-amendments/SPEC.md | sed -n '260,340p'" in /var/home/hasnobeef/buildepicshit/bes-fleet-policy
 succeeded in 0ms:
   260	§17 Open Questions as v1.1 candidates.
   261	
   262	### §7.E — v2.0 Repack Contract §6.1 + §8: expand manifest schema (finding 3.5)
   263	
   264	Target:
   265	`file://../../../agentic-ops-framework/specs/2026-05-19-v2-manifest-catalog-repack/SPEC.md`
   266	§6.1 + §8.
   267	
   268	Patch: amend the front-door manifest schema to add the
   269	following fields at the top level:
   270	
   271	- `schema_uri` (string, REQUIRED) — URL of the schema
   272	  this manifest conforms to (currently inline at §6.1;
   273	  externalising lets adopters reference a versioned
   274	  remote schema).
   275	- `source_commit` (string, REQUIRED) — git commit SHA the
   276	  bundle was generated from (binds the bundle to its
   277	  source-of-truth state).
   278	- `source_tag` (string, OPTIONAL) — git tag if the bundle
   279	  corresponds to a tagged release.
   280	- Per-facet record fields: `media_type` (string,
   281	  RECOMMENDED), `digest` (string, RECOMMENDED;
   282	  `algorithm:hex` form per OCI Descriptor convention),
   283	  `size` (integer, OPTIONAL), `status` (enum:
   284	  `complete` | `partial` | `reserved`; RECOMMENDED; allows
   285	  the manifest to advertise scaffold-status explicitly).
   286	- Per-resource record: same `media_type` + `digest` +
   287	  `size` fields.
   288	- `provenance` (object, OPTIONAL) — SBOM ref + SLSA
   289	  attestation refs once those primary corpus entries
   290	  land.
   291	
   292	Bumps manifest `spec_version` to `2.1.0`. Lands as v2.1
   293	of agentic-ops-framework when authored; the v2.0.0
   294	release stays at the current schema.
   295	
   296	### §7.F — v2.0 Repack Contract §8.3 + validate-manifest: behavior.primary file-vs-directory drift (finding 3.6)
   297	
   298	Target: repack SPEC §8.3 facet record schema + the
   299	validator script.
   300	
   301	Patch:
   302	
   303	- §8.3 amendment: `primary` MAY be either a file path OR
   304	  a directory path with a `primary_index` field naming
   305	  the entry-point file inside the directory. The
   306	  behavior facet uses the directory form because its
   307	  primary content is a set of `.feature` files.
   308	- `validate-manifest.sh` amendment: when `primary` ends
   309	  in `/`, the validator requires the directory to exist
   310	  AND contain at least one `.feature` file (or
   311	  equivalent extension per the facet). The current
   312	  silent-allow on directory primaries is replaced with
   313	  this explicit branch.
   314	
   315	Bumps manifest `spec_version` to `2.1.0` (same release as
   316	§7.E).
   317	
   318	### §7.G — Follow-on Task SPEC: corpus-citation lint extension (finding 4.2)
   319	
   320	This sub-amendment does NOT execute the lint extension;
   321	it BINDS the obligation that the lint extension be
   322	authored as a follow-on Task SPEC within the next
   323	Product B release cycle. The Task SPEC will:
   324	
   325	- Author `scripts/validate-corpus-citations.sh` OR
   326	  extend `scripts/lint-spec.sh` with a corpus-mode flag.
   327	- Enforce that every methodology-primitive citation in
   328	  the longread chapters + SPEC bundle facet files
   329	  resolves to a `file://research/primary-sources/<slug>.md
   330	  §3` reference.
   331	- Be added to CI as a fifth Product B job.
   332	- Update the corpus Contract SPEC §7.1 and the longread
   333	  Contract SPEC §13 AC-8 to reference the new enforcement
   334	  surface and remove the "manual reviewer" deferral.
   335	
   336	Authoring this Task SPEC is queued but not blocking on
   337	this Contract's verification. The Task SPEC's
   338	authorisation is `decision-authority://owner:2026-05-19`
   339	+ this Contract's §7.G binding.
   340	

exec
/home/linuxbrew/.linuxbrew/bin/bash -c "rg -n \"real and distinct|Identical reasoning to 5\\.2|Methodology AS a SPEC bundle only|SPEC-bundle-only \\(no longread\\)|5\\.2 SPEC-bundle-only|5\\.6 SPEC-bundle-only\" specs/2026-05-18-agentic-installation-methodology/SPEC.md" in /var/home/hasnobeef/buildepicshit/bes-fleet-policy
 succeeded in 0ms:
162:### 5.2 Methodology AS a SPEC bundle only
245:### 5.6 SPEC-bundle-only (no longread) [REJECTED]
259:  case-study delivery. Identical reasoning to 5.2; this
...
exec
/home/linuxbrew/.linuxbrew/bin/bash -c "nl -ba specs/2026-05-18-agentic-installation-methodology/SPEC.md | sed -n '158,178p;245,268p;503,509p'" in /var/home/hasnobeef/buildepicshit/bes-fleet-policy
 succeeded in 0ms:
   158	- Risk: Scope sprawl mitigated by hard per-facet word limits
   159	  plus facet-level negative-space discipline. (`file://specs/2026-05-17-agentic-installation-methodology/RESEARCH.md`
   160	  §4.2.)
...
exec
/home/linuxbrew/.linuxbrew/bin/bash -c 'git diff --stat && git status --short' in /var/home/hasnobeef/buildepicshit/bes-fleet-policy
 succeeded in 0ms:
codex
**Per-Finding Verdicts**

1.2 PARTIAL: RESOLVED.  
§4 now lists and weights the new “Executable conformance + signed-distribution surface” criterion, and §7 now separates first-class structural status from actual cryptographic signing readiness. The unsigned v1.0 path is explicitly disclosed via `signature.status: unsigned`. See [SPEC.md](/var/home/hasnobeef/buildepicshit/bes-fleet-policy/specs/2026-05-18-agentic-installation-methodology/SPEC.md:131) and [SPEC.md](/var/home/hasnobeef/buildepicshit/bes-fleet-policy/specs/2026-05-18-agentic-installation-methodology/SPEC.md:307).

1.4 PARTIAL: RESOLVED.  
§9 now forecloses any Product B shape omitting either the longread or the SPEC bundle, and explicitly catches the academic-channel-primary + SPEC-bundle composite by the missing-longread rule. See [SPEC.md](/var/home/hasnobeef/buildepicshit/bes-fleet-policy/specs/2026-05-18-agentic-installation-methodology/SPEC.md:442).

§7 stale “eight catalogued in §6” reference: RESOLVED.  
The clause now points to the §7 Decision Statement’s facet list and explicitly states §6 is the trade-off matrix, not the facet catalogue. See [SPEC.md](/var/home/hasnobeef/buildepicshit/bes-fleet-policy/specs/2026-05-18-agentic-installation-methodology/SPEC.md:380).

§11/§12 stale candidate/matrix counts: RESOLVED for the stale-count defect.  
§11 now says `5.1-5.6`; §12 now says the SPEC compares 6 candidates and has `7 criteria × 6 candidates = 42 cells`. See [SPEC.md](/var/home/hasnobeef/buildepicshit/bes-fleet-policy/specs/2026-05-18-agentic-installation-methodology/SPEC.md:505) and [SPEC.md](/var/home/hasnobeef/buildepicshit/bes-fleet-policy/specs/2026-05-18-agentic-installation-methodology/SPEC.md:528).
...
ADVISORY: §14 Completion Report still records stale evidence: `47 citation hits`, `4 candidates × 5 fields`, and `6×4 trade-off matrix`. Current lint reports 64 citation hits, and the current matrix is 6 candidates × 7 criteria. See [SPEC.md](/var/home/hasnobeef/buildepicshit/bes-fleet-policy/specs/2026-05-18-agentic-installation-methodology/SPEC.md:560) and [SPEC.md](/var/home/hasnobeef/buildepicshit/bes-fleet-policy/specs/2026-05-18-agentic-installation-methodology/SPEC.md:574).

**Quality Gate Result**

FAIL, review gate only. The four Round-2 follow-ups are remediated, and both declared lint commands pass with 0 errors / 0 warnings. But the new §11 distinctness overclaim is a material validation-plan defect. No mutations were made; working tree remained clean.
