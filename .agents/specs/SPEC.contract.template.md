...
<!--
Template per `specs/2026-05-01-bes-spec-authoring-procedure-v1/SPEC.md` §9.3.
...
Quality gate: bar (c) "Contract-grade", with REQUIRED `lint-spec.sh`
...
`file://agents/specs/SPEC.schema.md` §1.3 and the 2026-05-17
...
(`file://agents/specs/SPEC.schema.md` §1.3) and the validation
...
<!-- guidance: per the 2026-05-17 ceremony-weight-refactor
